<script >
	import Row from "@/common/Web3Modal/Web3Manager/SelectRow.vue";
	import { onClickOutside, useUrlSearchParams } from "@vueuse/core";
	import { useI18n } from "vue-i18n";
	import { CHAIN_INFO } from "@/common/Web3Modal/constants/chainInfo";
	import { CHAIN_IDS_TO_NAMES, SupportedChainId } from "../constants/chains";
	import { useActiveWeb3Vue } from "@/common/Web3Modal/hooks";
	import { ChevronDownIcon as ChevronDown } from "@/common/Web3Modal/assets/icons";
	import styled from "vue3-styled-component";
	import { MEDIA_WIDTHS } from "@/common/Web3Modal/theme";
	import { switchToNetwork } from "@/common/Web3Modal/utils/switchToNetwork";
...
<template>
	<SelectorWrapper ref="node">
		...
		>
			...
			/>
			<Row
				:target-chain="SupportedChainId.BINANCE_TESTNET"
				@click.prevent="handleChainSwitch({targetChain:SupportedChainId.BINANCE_TESTNET})"
			/>
		</FlyoutMenu>
