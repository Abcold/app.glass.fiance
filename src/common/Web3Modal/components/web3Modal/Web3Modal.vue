<template>
	<ModalOverlay :is-open="showing">
		<wrapper v-show="showing">
			...
			<AccountDetails
				v-else-if="provider && isValidNetwork && connected && active && walletView === 'account'"
				:connector="provider"
				:address="account"
				:chain-id="chainId"
			></AccountDetails>
...
<script>
	import { parseSendReturn } from "@/common/Web3Modal/utils/providerOptions";
	import _debounce from "lodash.debounce";
	import _find from "lodash.find";
	import styled from "vue3-styled-component";
	import { XIcon as Close } from "@/common/Web3Modal/assets/icons";
	import { ContentWrapper } from "@/common/Web3Modal/theme";
	import AccountDetails from "./AccountDetails";
	import ConnectModal from "./ConnectModal";
	import ModalOverlay from "@/common/Web3Modal/components/Modal.vue";
	import PendingView from "./PendingView";
	import Web3 from "web3";
	import { ref } from "vue";
	import { blockUpdater } from "@/common/Web3Modal/hooks/useBlockNumber";
	import { Updater as TxUpdater } from "@/common/Web3Modal/hooks/useTxs";
	import {
		useActiveWeb3Vue,
		activate,
		deactivate,
		...
		setAccounts,
		setBalance,
	} from "@/common/Web3Modal/hooks";
	import { isMobile } from "mobile-device-detect";
	import { useWeb3ModalToggle } from "@/common/Web3Modal/hooks/useModalsToggle";
	...
	import { useProviderOptions } from "@/common/Web3Modal/hooks/useProvider";
		...
		methods: {
          ...
          const {
            provider: storeProvider
					...
					setProvider(this.pendingWallet);
          storeProvider.value = this.pendingWallet
