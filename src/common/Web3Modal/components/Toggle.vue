<template>
	<StyledToggle :isActive="modelValue" :onClick="toggle">
		<ToggleElement :isActive="modelValue" :isOnSwitch="true"> On </ToggleElement>
		<ToggleElement :isActive="!modelValue" :isOnSwitch="false"> Off </ToggleElement>
	</StyledToggle>
</template>
<script>
